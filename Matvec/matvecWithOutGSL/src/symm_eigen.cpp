...
////////////////////////////////////////////////////////////
// some routinrs are  from numerical recipes in C
// double **a turns itself into eigenvectors
////////////////////////////////////////////////////////////
#include <cmath>
#include "vector.h"

namespace matvec {
////////////////// the following is for symmetric matrix ////////////////
...
void tqli(double *d,double *e,int n,double **z)
{
   ...
   for (l=0; l<n; l++) {
      ...
      do {
         ...
         if (m != l) {
            if (iter++ == 30) {
	      throw exception("tqli():  Too many iterations");
	    }
            g = (d[l+1]-d[l])/(2.0*e[l]);
            r = std::sqrt((g*g)+1.0);
